...
public class Shopping {
	...
	public static void main(String[] args) throws InValidBasketException {
	...
	public void calculateTolalPrice(Basket basket) throws InValidBasketException {
		if(basket == null) throw new InValidBasketException("null basket");
		...
		basket.getProducts().stream().forEach(product -> {
										...
										if(offer != null){
											...
											product.setTotalPrice(product.getPrice().multiply(product.getQuantity()));
									    }
